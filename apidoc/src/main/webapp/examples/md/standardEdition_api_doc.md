...
| attachs/scopeGUID            | 是   | list      | 64   | 范围对象编号，<br>attachLevel=1，scopeGUID为空；<br>attachLevel=4,scopeGUID取值为项目编号;<br>attachLevel=16,scopeGUID取值为公司编号;<br>取自数据服务接口data/attachs/items/的scopeGUID去重后的并集  |
